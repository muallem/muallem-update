...
class Index extends Component
{
    ...
    public function getKata()
    {
        ...
        $this->kata += 1;
        $thesis = Judul::select('juduls.id', 'juduls.category_id', 'wp_users.user_login', DB::raw('COUNT(materi_feedback.id) as materi_count'))
            ...
            ->groupBy('juduls.id', 'juduls.category_id', 'wp_users.user_login')
            ->get()->toArray();
