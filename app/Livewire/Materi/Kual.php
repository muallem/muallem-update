...
class Kual extends Component
{
    ...
    {
        $this->tab1 = 'kual-latar_belakang_masalah';
        $this->tab2 = 'kual-latar_belakang_masalah';
        $this->kode_materi = 'kual-latar_belakang_masalah';
        $this->getData();
    } 
    ...
    {
        $this->getData();
        return view('livewire.materi.kual');
    }
}
