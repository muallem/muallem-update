                            ...
                            <li class="ms-5">
                                ...
                                @if (!empty($item['category']))
                                    <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                        ...
                                        <li><a href="{{route('dashboard.lesson_detail', ['lesson_detail_id' => Crypt::encryptString($lesson['lesson_details'][0]['lesson_id']), 'judul_id' => Crypt::encryptString($item['id'])])}}">{{$lesson['chapter']}}</a></li>
                                        @endforeach
                                    </ul>
                                @endif
                                </li>
