                ...
                <form class="chat-input px-3" wire:submit.prevent='store'>
                    <ul class="nav nav-tabs nav-tabs-new2" role="tablist">
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-latar_belakang_masalah', 'kuan-latar_belakang_masalah')">
                            <a class="nav-link {{ $tab1 === 'kuan-latar_belakang_masalah' ? ' active show' : '' }}" style="border-bottom:2px solid #2eacb3;" data-bs-toggle="tab" href="#kuan-latar_belakang_masalah" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-rumusan_masalah', 'kuan-rumusan_masalah')">
                            <a class="nav-link {{ $tab1 === 'kuan-rumusan_masalah' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-rumusan_masalah" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-tujuan_penelitian', 'kuan-tujuan_penelitian')">
                            <a class="nav-link {{ $tab1 === 'kuan-tujuan_penelitian' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-tujuan_penelitian" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-manfaat_penelitian', 'kuan-manfaat_penelitian')">
                            <a class="nav-link {{ $tab1 === 'kuan-manfaat_penelitian' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-manfaat_penelitian" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-hipotesis_penelitian', 'kuan-hipotesis_penelitian')">
                            <a class="nav-link {{ $tab1 === 'kuan-hipotesis_penelitian' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-hipotesis_penelitian" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-ruang_lingkup_penelitian', 'kuan-ruang_lingkup_penelitian')">
                            <a class="nav-link {{ $tab1 === 'kuan-ruang_lingkup_penelitian' ? ' active show' : '' }}" style="border-bottom:2px solid #2eacb3;" data-bs-toggle="tab" href="#kuan-ruang_lingkup_penelitian" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-definisi_operasional', 'kuan-definisi_operasional')">
                            <a class="nav-link {{ $tab1 === 'kuan-definisi_operasional' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-definisi_operasional" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-kajian_terdahulu', 'kuan-kajian_terdahulu')">
                            <a class="nav-link {{ $tab1 === 'kuan-kajian_terdahulu' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-kajian_terdahulu" aria-selected="true" role="tab" >
                        ...
                        <li class="nav-item" role="presentation" wire:click="setKodeMateri('kuan-landasan_teori', 'kuan-landasan_teori')">
                            <a class="nav-link {{ $tab1 === 'kuan-landasan_teori' ? ' active show' : '' }}" data-bs-toggle="tab" style="border-bottom:2px solid #2eacb3;" href="#kuan-landasan_teori" aria-selected="true" role="tab" >
