                    ...
                    <div>
                        ...
                        <nav class="sidebar-nav">
                            <ul class="main-menu metismenu list-unstyled">
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=2"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=2" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> kual 
                                        </a>
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=3"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=3" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> rnd 
                                        </a>
                                        <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                            <li><a href="emp-all.html">All Employees</a></li>
                                            <li><a href="emp-leave.html">Leave Requests</a></li>
                                        ...
                                        <a href="#" class="text-decoration-none text-dark" aria-expanded="false">
                                            <i class="fa fa-user"></i>
                                            <span>Muhammad Adi Pratama Yudha Agusti</span> 
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=4"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=4" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> rnd 
                                        </a>
                                        <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                            <li><a href="emp-all.html">All Employees</a></li>
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=5"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=5" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> kuan 
                                        </a>
                                        <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                            <li><a href="emp-all.html">All Employees</a></li>
                                            <li><a href="emp-leave.html">Leave Requests</a></li>
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=6"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=6" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> kual 
                                        </a>
                                        <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                            <li><a href="emp-all.html">All Employees</a></li>
                                    ...
                                    <li class="ms-5"><a href="https://kitabah.muallem.id/admin/judul?thesis_id=7"><i class="fa fa-file-text"></i> Judul </a></li>
                                    <li class="ms-5">
                                        <a href="https://kitabah.muallem.id/admin/materi?thesis_id=7" class="has-arrow" aria-expanded="true">
                                            <i class="fa fa-tasks"></i> rnd 
                                        </a>
                                        <ul class="list-unstyled mm-collapse" style="height: 0px;">
                                            <li><a href="emp-all.html">All Employees</a></li>
